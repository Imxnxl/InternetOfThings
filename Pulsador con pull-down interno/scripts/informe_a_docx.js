...
const doc = new Document({
  ...
  title: "Informe tecnico - Pulsador con resistencia pull-down interna (ESP32-C6)",
  description: "Practica de entrada y salida digital en el ESP32-C6 usando la resistencia pull-down integrada en lugar de una fisica.",
  numbering: {
    config: [{
